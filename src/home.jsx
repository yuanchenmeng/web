              ...
              <div className="flex mt-6">
                ...
                <div className="w-full ">
                  <div className="flex justify-between font5 flex-wrap">
                    ...
                    <div className="flex-shrink-0 adj1"> 09-2021-06/2025</div>
                  </div>
                  <div className="flex justify-between font5 flex-wrap">
            ...
            <div className="main-width mx-auto mb-10">
              <div className="flex mt-6">
                ...
                <div className="w-full">
                  ...
                  <p className="dotpara">
                    Reduced filtered data rendering time by 90% through tuning MySQL query and index and
                    optimizing filter algorithm.
                  </p>
                  <p className="dotpara">
                    Developed API endpoints to receive gene files in JSON or FASTA, saving them in the database
                    and enabling gene visualization and comparison on the frontend using React and TypeScript
                  </p>
                  <p className="dotpara">
                    Leveraged Docker to containerize Frontend for scalability and deployment
                  </p>
                  <p className="dotpara">
                    Work on an Agile team with regular standups, sprints, and retrospectives.
                  </p>
                </div>
              </div>
